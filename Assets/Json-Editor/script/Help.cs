...
public class Help : MonoBehaviour
{
    ...
    public void Show()
    {
        ...
        box_help.set_title(app.carrot.L("help","Help"));

        Carrot_Box_Item item_help1 = box_help.create_item("help_1");
        item_help1.set_title(app.carrot.L("help1","How to create objects"));
        item_help1.set_tip(app.carrot.L("help1_tip","Generate source code with objects that simulate properties and data nodes"));
        ...
        item_help2.set_title(app.carrot.L("help2","Edit data blocks"));
        item_help2.set_tip(app.carrot.L("help2_tip","You can change values and delete data nodes easily using the corresponding function buttons in the data block"));
        ...
        item_help3.set_title(app.carrot.L("help3","Set properties for the object"));
        item_help3.set_tip(app.carrot.L("help3_tip","You can set properties and values for an object with built-in data types"));
